---
title: 'My Legacy'
description: 'My Legacy case study. Inception, research, prototyping, UI design, redesign of information architecture.'
---
...
<figure>
  <img
    src="./my-legacy-2-lofi-flows.jpg"
    alt="User and system flows with lo-fi wireframes"
  />
  <figcaption>
    Mapping flows with lo-fi wireframes allows us to quickly uncover technical
...
<figure>
  <img
    src="./my-legacy-3-hifi-utfindings.jpg"
    alt="Usability testing results with hi-fi mockups"
  />
  <figcaption>Usability testing results with hi-fi mockups.</figcaption>
</figure>
...
<figure>
  <img
    src="./my-legacy-6-ia-issues.jpg"
    alt="My Legacy website with the old information architecture"
  />
  <figcaption>
    My Legacy website with the old information architecture.
  </figcaption>
</figure>
...
<figure>
  <img
    src="./my-legacy-8-ia-design-changes-homepage.jpg"
    alt='New information architecture — homepage and overview page for "When Death Happens"'
  />
  <figcaption>
    New information architecture — homepage and overview page for "When Death
    Happens"
  </figcaption>
</figure>
...
<figure>
  <img
    src="./my-legacy-9-ia-design-changes-vault.jpg"
    alt='New information architecture — My Legacy vault'
  />
  <figcaption>
    New information architecture — My Legacy vault
  </figcaption>
</figure>